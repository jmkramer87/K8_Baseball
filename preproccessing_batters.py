...
df1 = pd.read_csv('~/data/Batters 2022.csv', sep=';', encoding='UTF-8')
df2 = pd.read_csv('~/data/Batters 2023.csv', sep=';', encoding='UTF-8')
df3 = pd.read_csv('~/data/Batters 2024.csv', sep=';', encoding='UTF-8')
